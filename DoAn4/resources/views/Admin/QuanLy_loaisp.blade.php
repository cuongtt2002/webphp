                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <table id="datatable" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="/loaisp_xoa/{{$item->id}}" method="POST">
                                                <a href="/QuanLy_loaisp_update/{{$item->id}}" class="btn btn-info btn-xs" ><i class="fa fa-pencil"></i> Cập nhật </a>   
                                                @csrf
                                                @method('DELETE')
                            ...
                            <div class=""style="margin-left:500px">{{$listloai->appends(request()->all())->links()}}</div>
                        </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form novalidate name="frmLoaiSP"  class="form-horizontal row-border" action="/loaisp_them" method="POST">
                                            @csrf
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="input17">Ten loai</label>
                                                    <div class="col-md-7"> <input type="text" id="idTenThuongHieu" class="form-control" name="TenLoaiSanPham"  /> </div>
                                                </div>
                                                <div class="form-group">
