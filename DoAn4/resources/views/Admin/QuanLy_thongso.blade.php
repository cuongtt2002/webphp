        ...
        <div class="">
            <div class="row" ng-app="myApp" ng-controller="LoaiSPAdController">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Quản lý Thông Số<small></small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <table id="datatable" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th><a>Mã thông số </a></th>
                                        <th><a>Tên thông số</a></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->TenSP}}</td>
                                        <td>
                                            <form action="/thongso_xoa/{{$item->id}}" method="POST">
                                                <a href="/QuanLy_thongso_update/{{$item->id}}" class="btn btn-info btn-xs" ><i class="fa fa-pencil"></i> Cập nhật </a>   
                                                @csrf
                                                @method('DELETE')
                            ...
                            <div class=""style="margin-left:500px">{{$thongso->appends(request()->all())->links()}}</div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form novalidate name="frmLoaiSP" id="frmLoaiSP" class="form-horizontal row-border" action="/thongso_them" method="POST">
                                    @csrf
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="input17">Tên thông tin </label>
                                            <div class="col-md-7"> <input type="text"  class="form-control" name="TenThongSo" /> </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="input17">Mô Tả thông tin </label>
                                            <div class="col-md-7"> <input type="text"  class="form-control" name="MoTaThongTin" /> </div>
                                        </div>
                                        <div class="form-group">
