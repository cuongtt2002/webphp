        ...
        <div class="">
            <div class="row" ng-app="myApp" ng-controller="LoaiSPAdController">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Quản lý người dùng  <small></small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <form action="" class="form-inline" role="form">
                                <div class="form-group">
                                    ...
                                    <input name="key" class="form-control" id=""/>
                                </div>
                            ...
                            <table id="datatable" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->email}}</td>
                                        <td>
                                            <img style="with:120px;height:50px" src="nguoidung/Images/avatar/{{$item->avatar}}" alt="không có ảnh" />
                                        </td>
                                        <td>{{$item->phone}}</td>
                                        <td>{{$item->password}}</td>
                                        <td>{{$item->role}}</td>
                                        <td>{{$item->status}}</td>
                                        <td>
                                            <form action="/nguoidung_xoa/{{$item->id}}" method="POST">
                                                <a href="/QuanLy_nguoidung_update/{{$item->id}}" class="btn btn-info btn-xs" ><i class="fa fa-pencil"></i> Cập nhật </a>   
                                                @csrf
                                                @method('DELETE')
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form novalidate  class="form-horizontal row-border" action="/nguoidung_them" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                         <input type="file" id="idTenThuongHieu" class="form-control" name="avatar"  /> 
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="input17">SoDienThoai</label>
                                                    <div class="col-md-7"> <input type="text" id="idTenThuongHieu" class="form-control" name="phone"  /> </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="input17">Password</label>
                                                    <div class="col-md-7"> <input type="password" id="idTenThuongHieu" class="form-control" name="password"  /> </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="input17">Quyền</label>
                                                    <div class="col-md-7"> 
                                                        <select class="form-control" name="role">
                                                            <option value="1">KhachHang</option>
